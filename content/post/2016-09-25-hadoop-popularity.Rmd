...
```{r}
library(tidyverse)
pig <- read.csv("~/github/blogdown2/data/pig.csv", header = TRUE)
hive <- read.csv("~/github/blogdown2/data/hive.csv", header = TRUE)
...
```{r}
hadoop <- read.csv("~/github/blogdown2/data/hadoop.csv", header = TRUE)
hbase <- read.csv("~/github/blogdown2/data/hbase.csv", header = TRUE)
spark <- read.csv("~/github/blogdown2/data/spark.csv", header = TRUE)
mahout <- read.csv("~/github/blogdown2/data/mahout.csv", header = TRUE)
mapreduce <- read.csv("~/github/blogdown2/data/mapreduce.csv", header = TRUE)
