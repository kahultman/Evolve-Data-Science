...
hadoop <- read.csv("data/hadoop.csv", header = TRUE)
hbase <- read.csv("data/hbase.csv", header = TRUE)
spark <- read.csv("data/spark.csv", header = TRUE)
mahout <- read.csv("data/mahout.csv", header = TRUE)
mapreduce <- read.csv("data/mapreduce.csv", header = TRUE)
